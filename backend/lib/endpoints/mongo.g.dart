...
// **************************************************
// gisila_doc: generated for MongoApi
// **************************************************

extension MongoApiGisilaDoc on MongoApi {
  ...
  void attachToApp(
    ...
    spec.putSchema('CreateMongoInstanceForm', <String, Object?>{
      'type': 'object',
    ...
    spec.putSchema('CreateMongoDatabaseForm', <String, Object?>{
      'type': 'object',
      'properties': <String, Object?>{
        'dbName': <String, Object?>{'type': 'string'},
        'userName': <String, Object?>{'type': 'string'},
        'password': <String, Object?>{'type': 'string'},
        'roles': <String, Object?>{'type': 'object'}
      }
    });
    spec.putSchema('UpdateMongoRolesForm', <String, Object?>{
      'type': 'object',
      'properties': <String, Object?>{
        'roles': <String, Object?>{'type': 'object'}
      }
    ...
    spec.putTag('MongoDB');
    {
      final basePath = '$prefix/mongo/';
      final openApiPath = '$prefix/mongo/';
      ...
      router.get(
          ...
          gisilaRoute(
            ...
            handler: (RequestContext ctx) async {
              try {
                final svc = ctx.service<MongoService>();
      ...
      spec.putOperation(
          ...
          'get',
          Operation(
            summary: 'List installed MongoDB instances',
            tags: <String>['MongoDB'],
    ...
    }
    {
          ...
          gisilaRoute(
            ...
            handler: (RequestContext ctx) async {
              try {
                ...
                final form =
                    await bindForm(request, CreateMongoInstanceForm.new);
                final svc = ctx.service<MongoService>();
      ...
      spec.putOperation(
          ...
          'post',
          Operation(
            summary: 'Install a MongoDB version',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[],
            requestBody: RequestBody(required: true, content: {
              'application/json': MediaType(schema: <String, Object?>{
                r'$ref': '#/components/schemas/CreateMongoInstanceForm'
              })
            }),
            responses: <String, ResponseSpec>{
    ...
    {
      final basePath = '$prefix/mongo/<id>';
      final openApiPath = '$prefix/mongo/{id}';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.get(
          basePath,
      ...
      spec.putOperation(
          ...
          'get',
          Operation(
            summary: 'Get a MongoDB instance',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
    ...
    {
      final basePath = '$prefix/mongo/<id>/start';
      final openApiPath = '$prefix/mongo/{id}/start';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.post(
          basePath,
      ...
      spec.putOperation(
          ...
          'post',
          Operation(
            summary: 'Start a MongoDB instance',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
    ...
    {
      final basePath = '$prefix/mongo/<id>/stop';
      final openApiPath = '$prefix/mongo/{id}/stop';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.post(
          basePath,
      ...
      spec.putOperation(
          ...
          'post',
          Operation(
            summary: 'Stop a MongoDB instance',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
    ...
    {
      final basePath = '$prefix/mongo/<id>/set-default';
      final openApiPath = '$prefix/mongo/{id}/set-default';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.post(
          basePath,
      ...
      spec.putOperation(
          ...
          'post',
          Operation(
            summary: 'Set as the preferred MongoDB instance',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
    ...
    {
      final basePath = '$prefix/mongo/<id>/retry';
      final openApiPath = '$prefix/mongo/{id}/retry';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.post(
          basePath,
      ...
      spec.putOperation(
          ...
          'post',
          Operation(
            summary: 'Retry a failed MongoDB installation',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
    ...
    {
      final basePath = '$prefix/mongo/<id>/expose';
      final openApiPath = '$prefix/mongo/{id}/expose';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.post(
          basePath,
    ...
    }
    {
      ...
      spec.putOperation(
          ...
          'delete',
          Operation(
            summary: 'Uninstall a MongoDB instance',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
    ...
    {
      final basePath = '$prefix/mongo/<id>/metrics';
      final openApiPath = '$prefix/mongo/{id}/metrics';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.get(
          basePath,
    ...
    {
      final basePath = '$prefix/mongo/<id>/config';
      final openApiPath = '$prefix/mongo/{id}/config';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.get(
          basePath,
      ...
      spec.putOperation(
          ...
          'get',
          Operation(
            summary: 'Read tunable mongod settings',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
    ...
    }
    {
      ...
      spec.putOperation(
          ...
          'put',
          Operation(
            summary: 'Update tunable mongod settings',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
    ...
    {
      final basePath = '$prefix/mongo/<id>/dbs';
      final openApiPath = '$prefix/mongo/{id}/dbs';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.get(
          basePath,
    ...
    }
    {
            ...
            handler: (RequestContext ctx) async {
              try {
                ...
                final id =
                    coerce<int>(request.params['id'], 'id', required: true);
                final form =
                    await bindForm(request, CreateMongoDatabaseForm.new);
                final svc = ctx.service<MongoService>();
      ...
      spec.putOperation(
          ...
          'post',
          Operation(
            summary: 'Create a database + authenticated user',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
            ...
            requestBody: RequestBody(required: true, content: {
              'application/json': MediaType(schema: <String, Object?>{
                r'$ref': '#/components/schemas/CreateMongoDatabaseForm'
              })
            }),
            responses: <String, ResponseSpec>{
              '201': ResponseSpec(description: 'Created', content: {
    ...
    {
      final basePath = '$prefix/mongo/<id>/dbs/<dbId>/roles';
      final openApiPath = '$prefix/mongo/{id}/dbs/{dbId}/roles';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.put(
          basePath,
          gisilaRoute(
            ...
            handler: (RequestContext ctx) async {
              try {
                ...
                final form = await bindForm(request, UpdateMongoRolesForm.new);
                final svc = ctx.service<MongoService>();
                final result = await this.updateRoles(id, dbId, form, svc, ctx);
                return jsonResponse(body: result, statusCode: 200);
              } on TypeError catch (e) {
                throw BadRequestException('Invalid request payload ($e)');
              } on FormatException catch (e) {
      ...
      spec.putOperation(
          ...
          'put',
          Operation(
            summary: 'Update a database user\'s roles',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
            ...
            requestBody: RequestBody(required: true, content: {
              'application/json': MediaType(schema: <String, Object?>{
                r'$ref': '#/components/schemas/UpdateMongoRolesForm'
              })
            }),
            responses: <String, ResponseSpec>{
              '200': ResponseSpec(description: 'OK', content: {
    ...
    {
      final basePath = '$prefix/mongo/<id>/dbs/<dbId>';
      final openApiPath = '$prefix/mongo/{id}/dbs/{dbId}';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.get(
          basePath,
    ...
    }
    {
      ...
      spec.putOperation(
          ...
          'delete',
          Operation(
            summary: 'Drop a database and its user',
            tags: <String>['MongoDB'],
            parameters: <Parameter>[
              Parameter(
                name: 'id',
    ...
    {
      final basePath = '$prefix/mongo/<id>/dbs/<dbId>/backups';
      final openApiPath = '$prefix/mongo/{id}/dbs/{dbId}/backups';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.get(
          basePath,
    ...
    {
      final basePath =
          '$prefix/mongo/<id>/dbs/<dbId>/backups/<backupId>/download';
      final openApiPath =
          '$prefix/mongo/{id}/dbs/{dbId}/backups/{backupId}/download';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
    ...
    {
      final basePath = '$prefix/mongo/<id>/dbs/<dbId>/backups/<backupId>';
      final openApiPath = '$prefix/mongo/{id}/dbs/{dbId}/backups/{backupId}';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.delete(
          basePath,
    ...
    {
      final basePath = '$prefix/mongo/<id>/dbs/<dbId>/restore';
      final openApiPath = '$prefix/mongo/{id}/dbs/{dbId}/restore';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.post(
          basePath,
    ...
    {
      final basePath = '$prefix/mongo/<id>/dbs/<dbId>/restore-upload';
      final openApiPath = '$prefix/mongo/{id}/dbs/{dbId}/restore-upload';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.post(
          basePath,
    ...
    {
      final basePath = '$prefix/mongo/<id>/dbs/<dbId>/backup-schedule';
      final openApiPath = '$prefix/mongo/{id}/dbs/{dbId}/backup-schedule';
      final RouteConfig __cfg =
          RouteConfig.empty.merge(const RouteConfig(requireAuth: true));
      router.get(
          basePath,
