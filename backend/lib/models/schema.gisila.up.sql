...
CREATE TABLE "apps" (
  ...
  "dart_version" VARCHAR(255),
  "go_version" VARCHAR(255),
  "rust_version" VARCHAR(255),
  "bun_version" VARCHAR(255),
  "celery_app" VARCHAR(255),
  "celery_worker_count" INTEGER,
  "celery_concurrency" INTEGER,
  "celery_queues" VARCHAR(255),
  "celery_beat_enabled" BOOLEAN DEFAULT FALSE,
